...
import os,sys    # for stdout
lib_path = os.path.abspath('D:\My Projects\PythonLearning')
sys.path.append(lib_path) #add file to path by Zhe
...
def main():
	while (True):
		sys.stdout.write("Generate random DNA strands? (Enter 'no' to exit)\n")
